...
-}
tellSign :: Int -> String
tellSign n = if n > 0 then "positive" else (if n == 0 then "zero" else "negative") 
...
-}
digitsCount :: Int -> Int
digitsCount n = if n > -10 && n < 10 then 1 else 1 + (digitsCount (quot n 10)) 
